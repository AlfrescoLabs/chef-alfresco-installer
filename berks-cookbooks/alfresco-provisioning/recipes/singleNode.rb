...
#                     :client_name => 'svidrascu-validator',
#                     :signing_key_filename => '~/.chef/svidrascu.pem'
...
#             recipe[alfresco-dbwrapper::postgres] recipe[alfresco-installer::installer] )
...
# #                         }
# #                     }
# #     run_list %w(recipe[java-wrapper::java8] recipe[alfresco-dbwrapper::mysql] recipe[alfresco-installer::installer] )
# #     attributes 'installer' =>
# #                    {'nodename' => 'singleNode',
# #                     'disable-components' => 'javaalfresco,postgres',
# #                     'downloadpath' => installerPath,
