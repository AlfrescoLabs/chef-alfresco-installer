...
cookbook "chef-alfresco-installer", path: '../chef-alfresco-installer'
# cookbook "chef-alfresco-installer", git: "https://github.com/AlfrescoTestAutomation/chef-alfresco-installer.git", branch: "master"
