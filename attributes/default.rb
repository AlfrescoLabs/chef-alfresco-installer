...
when 'windows'
  default['java_8_download_path'] = "ftp://172.29.103.222/chef-resources/jdk-8u40-windows-x64.exe"
...
when 'solaris','solaris2'
  ...
  default['java_8_download_path'] = "ftp://172.29.103.222/chef-resources/jdk-8u40-solaris-x64.tar.gz"
  ...
  default['java_8_download_path'] = "ftp://172.29.103.222/chef-resources/jdk-8u31-linux-x64.tar.gz"
